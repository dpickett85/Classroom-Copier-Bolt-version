...
export function attachmentFallbackNote(attachmentName) {
...
export function attachmentSkippedByUserNote(attachmentName) {
 ...
 * created for it.
 */
export function cancelledByUserNote() {
 ...
 */
export function duplicateSkipNote(matchedTitle, matchedState) {
    const where = matchedState === 'DRAFT'
 ...
 */
export function postCreatedFollowUpFailedNote(step) {
 ...
 */
export function shareModeUnknownNote(attachmentName) {
